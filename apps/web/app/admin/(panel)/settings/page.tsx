      ...
      {loading && !data ? (
        ...
        <>
          ...
          <FormSection
            ...
            description="Аккаунты создаются при первом входе через Telegram или по пасскею, паролей нет."
          >
            <FormField
              label="Код доступа"
              htmlFor="inviteCode"
              description="Пусто — регистрация открыта; иначе новые аккаунты создаются только с этим кодом. На уже вошедших не влияет."
